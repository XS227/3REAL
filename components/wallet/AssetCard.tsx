...
export function AssetCard({ meta, balance, t }: Props) {
    ...
    >
      ...
      <div className="mb-4 flex items-start justify-between">
        <div>
          ...
          >
            <AssetIcon code={meta.code} className="h-4.5 w-4.5" />
          </div>
      ...
      <div className="mb-4 grid grid-cols-2 gap-2 rounded-lg bg-zinc-950/50 px-3 py-2.5">
        <div>
          <p className="text-[10px] text-zinc-600">{t.available}</p>
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        >
          {t.viewDetails} <ArrowRight className="h-3 w-3 rtl:-scale-x-100" />
        </Link>
